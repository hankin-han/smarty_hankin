...
function(e, t) {
	...
	w.fn = w.prototype = {
		...
		var e, t, n, r, i, o, s = arguments[0] || {},
			...
			l = arguments.length,
			c = !1;
		for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || g(s) || (s = {}), a === l && (s = this, a--); a < l; a++) if (null != (e = arguments[a])) for (t in e) r = e[t], "__proto__" !== t && s !== r && (c && r && (w.isPlainObject(r) || (i = Array.isArray(r))) ? (n = s[t], o = i && !Array.isArray(n) ? [] : i || w.isPlainObject(n) ? n : {}, i = !1, s[t] = w.extend(c, o, r)) : void 0 !== r && (s[t] = r));
		return s
	}, w.extend({
	...
	var C = function(e) {
			...
			for (t in n = ae.support = {}, o = ae.isXML = function(e) {
				...
				}), m = m.length && new RegExp(m.join("|")), v = v.length && new RegExp(v.join("|")), t = J.test(h.compareDocumentPosition), b = t || J.test(h.contains) ?
				function(e, t) {
						...
						function(e) {
							...
							if (m) {
								...
								if (h = [s ? m.firstChild : m.lastChild], s && y) {
									for (b = (d = (c = (u = (f = (p = m)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && c[1]) && c[2], p = d && m.childNodes[d]; p = ++d && p && p[g] || (b = d = 0) || h.pop();) if (1 === p.nodeType && ++b && p === t) {
										u[e] = [T, d, b];
										break
									}
								} else if (y && (b = d = (c = (u = (f = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && c[1]), !1 === b) for (;
			...
			function xe(e, t, n) {
				...
				function(t, n, i) {
					...
					} else for (; t = t[r];) if (1 === t.nodeType || s) if (u = (f = t[x] || (t[x] = {}))[t.uniqueID] || (f[t.uniqueID] = {}), i && i === t.nodeName.toLowerCase()) t = t[r] || t;
					else {
			...
			function Ee(e, t, n, r, i, o) {
				return r && !r[x] && (r = Ee(r)), i && !i[x] && (i = Ee(i, o)), ce(function(o, s, a, l) {
					...
					function(e, t, n) {
						...
						return n
					}(t || "*", a.nodeType ? [a] : a, []), m = !e || !o && t ? g : Te(g, p, e, a, l), v = n ? i || (o ? e : h || r) ? [] : s : m;
					if (n && n(m, v, a, l), r) for (c = Te(v, d), r(c, [], a, l), u = c.length; u--;)(f = c[u]) && (v[d[u]] = !(m[d[u]] = f));
					if (o) {
						if (i || e) {
							if (i) {
			...
			function Ce(e) {
				for (var t, n, i, o = e.length, s = r.relative[e[0].type], a = s || r.relative[" "], l = s ? 1 : 0, u = xe(function(e) {
					...
					return t = null, i
				}]; l < o; l++) if (n = r.relative[e[l].type]) p = [xe(we(p), n)];
				else {
			...
			return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye, s = ae.tokenize = function(e, t) {
				...
				if (n = n || [], 1 === d.length) {
					...
					for (o = V.needsContext.test(e) ? 0 : l.length; o-- && (c = l[o], !r.relative[u = c.type]);) if ((f = r.find[u]) && (i = f(c.matches[0].replace(te, ne), ee.test(l[0].type) && ve(t.parentNode) || t))) {
	...
	(w.fn.init = function(e, t, n) {
		...
		if (n = n || H, "string" == typeof e) {
			...
			if (i[1]) {
				if (t = t instanceof w ? t[0] : t, w.merge(this, w.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : r, !0)), D.test(i[1]) && w.isPlainObject(t)) for (i in t) g(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
				return this
			}
	...
	function we(e, t, n, r, i) {
		for (var o, s, a, l, c, u, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === b(o)) w.merge(p, o.nodeType ? [o] : o);
		else if (xe.test(o)) {
		...
		for (f.textContent = "", d = 0; o = p[d++];) if (r && -1 < w.inArray(o, r)) i && i.push(o);
		else if (c = oe(o), s = me(f.appendChild(o), "script"), c && ve(s), n) for (u = 0; o = s[u++];) he.test(o.type || "") && n.push(o);
		return f
	}
	...
	w.event = {
		...
		remove: function(e, t, n, r, i) {
			...
			if (m && (l = m.events)) {
				for (c = (t = (t || "").match(M) || [""]).length; c--;) if (d = g = (a = Ce.exec(t[c]) || [])[1], h = (a[2] || "").split(".").sort(), d) {
	...
	function qe(e, t, n, r) {
		...
		if (p && (o = (i = we(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
			...
			if (l) for (u = a[a.length - 1].ownerDocument, w.map(a, Me), f = 0; f < l; f++) c = a[f], he.test(c.type || "") && !G.access(c, "globalEval") && w.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? w._evalUrl && !c.noModule && w._evalUrl(c.src, {
	...
	w.extend({
		...
		clone: function(e, t, n) {
			var r, i, o, s, a, l, c, u = e.cloneNode(!0),
				f = oe(e);
			if (!(h.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (s = me(u), r = 0, i = (o = me(e)).length; r < i; r++) a = o[r], "input" === (c = (l = s[r]).nodeName.toLowerCase()) && pe.test(a.type) ? l.checked = a.checked : "input" !== c && "textarea" !== c || (l.defaultValue = a.defaultValue);
			if (t) if (n) for (o = o || me(e), s = s || me(u), r = 0, i = o.length; r < i; r++) Pe(o[r], s[r]);
			else Pe(e, u);
	...
	function dt(e, t, n) {
		...
		for (function(e, t) {
			var n, r, i, o, s;
			for (n in e) if (i = t[r = z(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (s = w.cssHooks[r]) && "expand" in s) for (n in o = s.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i);
			else t[r] = i
		}(u, c.opts.specialEasing); o < s; o++) if (r = dt.prefilters[o].call(c, e, u, c.opts)) return g(r.stop) && (w._queueHooks(c.elem, c.opts.queue).stop = r.stop.bind(r)), r;
	...
	w.fn.extend({
		...
		addClass: function(e) {
			...
			if ((t = xt(e)).length) for (; n = this[l++];) if (i = bt(n), r = 1 === n.nodeType && " " + yt(i) + " ") {
		...
		toggleClass: function(e, t) {
			...
			return "boolean" == typeof t && r ? t ? this.addClass(e) : this.removeClass(e) : g(e) ? this.each(function(n) {
				...
				var t, i, o, s;
				if (r) for (i = 0, o = w(this), s = xt(e); t = s[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
			...
			var i, o, s, a, l, c, u, f, p, d, h = w.ajaxSetup({}, n),
				...
				C = {
					...
					getResponseHeader: function(e) {
						var t;
						if (u) {
							if (!a) for (a = {}; t = Rt.exec(s);) a[t[1].toLowerCase() + " "] = (a[t[1].toLowerCase() + " "] || []).concat(t[2]);
							t = a[e.toLowerCase() + " "]
						}
	...
	for (var q = Math.min, Y = Math.floor, X = Math.round, I = Math.max, B = "undefined" != typeof window && "undefined" != typeof document, F = ["Edge", "Trident", "Firefox"], $ = 0, _ = 0; _ < F.length; _ += 1) if (B && 0 <= navigator.userAgent.indexOf(F[_])) {
		$ = 1;
		break
	}
	var U = B && window.Promise ?
	function(e) {
		var t = !1;
		return function() {
	...
	}, z = B && !(!window.MSInputMethodContext || !document.documentMode), V = B && /MSIE 10/.test(navigator.userAgent), K = function(e, t) {
	...
	function(e) {
		...
		return e
	}, Z = B && /Firefox/i.test(navigator.userAgent), ee = ["auto-start", "auto", "auto-end", "top-start", "top", "top-end", "right-start", "right", "right-end", "bottom-end", "bottom", "bottom-start", "left-end", "left", "left-start"], te = ee.slice(3), ne = "flip", re = "clockwise", ie = "counterclockwise", oe = function() {
		function t(n, r) {
			var i = this,
	...
	var w = function(e, t, n, r, i) {
		...
		C = {
			...
			wheel: function(t) {
				...
				function r(e) {
					...
					if (!n(e.target, o, s)) {
						var a = !1;
						t.settings.useBothWheelAxes ? t.scrollbarYActive && !t.scrollbarXActive ? (s ? i.scrollTop -= s * t.settings.wheelSpeed : i.scrollTop += o * t.settings.wheelSpeed, a = !0) : t.scrollbarXActive && !t.scrollbarYActive && (o ? i.scrollLeft += o * t.settings.wheelSpeed : i.scrollLeft -= s * t.settings.wheelSpeed, a = !0) : (i.scrollTop -= s * t.settings.wheelSpeed, i.scrollLeft += o * t.settings.wheelSpeed), E(t), (a = a ||
						function(e, n) {
		...
		S = function(r, i) {
			...
			this.scrollbarYRight = parseInt(f.right, 10), isNaN(this.scrollbarYRight) ? (this.isScrollbarYUsingRight = !1, this.scrollbarYLeft = u(f.left)) : this.isScrollbarYUsingRight = !0, this.scrollbarYOuterWidth = this.isRtl ?
			function(t) {
				var n = e(t);
