...
$(document).ready(function () {
    ...
    <div class="style-block">
        ...
        <div class="m-style-scroller">
            ...
            <h6>背景颜色</h6>
            <div class="theme-color background-color flat"><a href="#!" class="active" data-value="background-blue"><span></span><span></span></a>
            ...
            <h6>背景图片</h6>
            <div class="theme-color background-color image"><a href="#!" class="" data-value="background-img-1"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-2"><span></span><span></span></a><a href="#!" class="" data-value="background-img-3"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-4"><span></span><span></span></a><a href="#!" class="" data-value="background-img-5"><span></span><span></span></a><a href="#!" class="" data-value="background-img-6"><span></span><span></span></a>
            </div>
    ...
    $("#box-layouts").change(function () {
        if ($(this).is(":checked")) {
            ...
            storage.setItem("box-layout", 'on')

        } else {
            $("body").removeClass("container");
            $("body").removeClass("box-layout");
            storage.setItem("box-layout", 'off')
        }
    });
