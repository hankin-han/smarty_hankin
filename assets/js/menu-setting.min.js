...
$(document).ready(function () {
    ...
    <div class="style-block">
        ...
        <div class="m-style-scroller">
            <h6 class="mt-2">列表样式</h6>
            <div class="theme-box-list">
            <a href="javascript:void(0)" data-value="box-list" class="btn btn-sm btn-outline-primary"><i class="feather icon-list"></i>列表式</a>
            <a href="javascript:void(0)" data-value="box-grid" class="btn btn-sm btn-outline-primary"><i class="feather icon-grid"></i>卡片式</a>
            </div>
            <h6 class="mt-2">布局</h6>
            ...
            <a href="#!" class="" data-value="background-img-7"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-8"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-9"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-10"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-11"><span></span><span></span></a>
            <a href="#!" class="" data-value="background-img-12"><span></span><span></span></a>
            </div>
    ...
    $("#box-layouts").change(function () {
        if ($(this).is(":checked")) {
            ...
            $.cookie('box-layout', 'container box-layout', { expires: 7 });
    ...
    $(".theme-box-list a").on("click",function(){
        var a = $(this).attr("data-value");
        $.cookie('theme-box-list', a, { expires: 7 });
        $(this).removeClass("btn-outline-primary").addClass("btn-primary");
        $(this).siblings().removeClass("btn-primary").addClass("btn-outline-primary");

        if($.cookie('theme-box-list') == "box-list" ){
            $("#list-home").show();
            $("#list-grid").hide();
        }else if($.cookie('theme-box-list') == "box-grid")
        {
            $("#list-home").hide();
            $("#list-grid").show();
        }else{
    ...
    if($.cookie('box-layout') == "container box-layout")
    {
        $("#box-layouts").attr("checked","checked");
    }else{

        $("#box-layouts").attr("checked","");
    }
