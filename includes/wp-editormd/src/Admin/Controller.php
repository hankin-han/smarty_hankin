...
class Controller {
	...
	public function enqueue_styles() {
		//Style - Editor.md
		wp_enqueue_style( 'Editormd', WP_EDITORMD_ABROAD_URL . '/assets/Editormd/editormd.min.css', array(), '2.0.1', 'all' );
		//Style - Config
		wp_enqueue_style( 'Config', WP_EDITORMD_ABROAD_URL . '/assets/Config/editormd.min.css', array(), $this->version, 'all' );
	}
	...
	public function enqueue_scripts() {
		...
		//JavaScript - Editormd
		wp_enqueue_script( 'Editormd', WP_EDITORMD_ABROAD_URL . '/assets/Editormd/editormd.min.js', array( 'jquery' ), '2.0.1', true );

		//JavaScript - Config
		wp_enqueue_script( 'Config', WP_EDITORMD_ABROAD_URL . '/assets/Config/editormd.min.js', array( 'Editormd' ), $this->version, true );

		//JavaScript - 载入国际化语言资源文件
		$lang = get_bloginfo( 'language' );
		switch ( $lang ) {
			case 'zh-TW':
				wp_enqueue_script( 'Editormd-lang-tw', WP_EDITORMD_ABROAD_URL . '/assets/Editormd/languages/zh-tw.js', array(), '2.0.1', true );//载入台湾语言资源库
				break;
			case 'zh-CN':
				break;
			case 'en-US':
				wp_enqueue_script( 'Editormd-lang-us', WP_EDITORMD_ABROAD_URL . '/assets/Editormd/languages/en.js', array(), '2.0.1', true );//载入美国英语语言资源库
				break;
			default:
				wp_enqueue_script( 'Editormd-lang-us', WP_EDITORMD_ABROAD_URL . '/assets/Editormd/languages/en.js', array(), '2.0.1', true );//默认载入美国英语语言资源库
		}
		...
		wp_localize_script( 'Config', 'Editormd', array(
			'editormdUrl'       => WP_EDITORMD_ABROAD_URL,
